            ...
            <div className="relative flex h-14 w-full flex-col justify-center">
                <div className="flex items-center justify-between">
                    <div className="flex items-center flex-row">
                        <a
                            href="/"
                            className="flex items-center justify-center h-8 text-sm font-semibold ml-4 hover:opacity-90 shrink-0"
                        >
                            Exchange
                        </a>
                        ...
                        <a
                            href="/"
                            className="flex items-center justify-center h-8 text-sm font-semibold mx-4 hover:opacity-90 shrink-0"
                        >
                            Trade
                        </a>
